...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│  Git Update                    [새로고침] [원격 확인] [전체 업데이트 9] [⚙]   │
│  저장소 20개 · 업데이트 9개 · 로컬 변경 14개                                  │
│  [ 이름 또는 경로 검색 ]  (전체 20)(업데이트 9)(로컬 변경 14)  기본 방식 [ff-only ▾]│
├──────────────────────────────────────────────────────────────────────────────┤
│ ▎ hermes/hermes-agent   업데이트 있음                                         │
│    main · 받을 커밋 3 · 확인 방금                          [ 업데이트 3 ] [ ⋯ ]│
│    ~/Documents/project/hermes/hermes-agent                                    │
├──────────────────────────────────────────────────────────────────────────────┤
│ ▎ graphify              분기됨                                                │
│    v4 · 받을 커밋 128 · 보낼 커밋 97 · 수정 6 · 보관 1     [ 업데이트 128 ] [ ⋯ ]│
│    ~/Documents/project/graphify                                               │
│    ⚠ 로컬 커밋이 있어 빨리감기가 안 됩니다.                                   │
│      [rebase 로 다시 시도] [merge 로 다시 시도] [보관 관리]                   │
├──────────────────────────────────────────────────────────────────────────────┤
│ ▎ insane-search         최신                                                  │
│    main · 최신 상태 · 확인 방금                              [ 업데이트 ] [ ⋯ ]│
└──────────────────────────────────────────────────────────────────────────────┘
   ▾ 실행 기록 (git 원본 출력 그대로)                        ● 모두 최신 상태입니다
```

- 손이 필요한 저장소가 위로 올라옵니다 (업데이트 → 분기 → 오류 → 로컬 변경 → 최신).
- 카드 왼쪽 색 띠와 상태 배지로 한눈에 구분됩니다.
- 라이트/다크 모드는 시스템 설정을 따라갑니다.
